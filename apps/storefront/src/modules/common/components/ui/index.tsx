  ...
  (
    ...
    return (
      <button
        ...
        className={clsx(
          "inline-flex min-w-0 gap-2 items-center justify-center rounded-xl font-medium leading-none text-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#17261f] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
          variant === "primary" && "bg-[#17261f] text-white hover:bg-[#22382d]",
          variant === "secondary" &&
            "bg-white text-[#17261f] border border-[#cbd7cd] hover:bg-[#f6f8f4]",
          variant === "transparent" && "bg-transparent hover:bg-gray-100",
          size === "small" && "h-9 px-3 text-sm",
          size === "medium" && "h-11 px-4 small:h-12 small:px-5",
